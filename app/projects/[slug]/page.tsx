  ...
  return (
    <article className="mx-auto max-w-300 px-4 pt-16 pb-20">
      ...
      <header className="mb-12 space-y-6">
        ...
        <h1 className="font-serif text-7xl max-lg:text-6xl max-md:text-5xl leading-tight tracking-tight text-sand-900">
          {frontmatter.title}
        </h1>

        <p className="font-serif text-2xl max-md:text-xl leading-relaxed text-sand-600">
